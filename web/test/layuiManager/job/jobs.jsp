    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'company', width:150, title: '公司名', edit: 'text'}
                ,{field:'department', width:150, title: '部门',  edit: 'text'}
                ,{field:'salary', width:120, title: '薪资区间', edit: 'text'}
                ,{field:'address', width:150, title: '地址',  edit: 'text'}
                ,{field:'jobType', width:150, title: '工作类型',  edit: 'text'}
