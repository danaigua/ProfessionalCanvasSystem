                    ...
                    <form class="layui-form" action="addUser" id="form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="user.userName" lay-verify="title" autocomplete="off" placeholder="请输入用户名" class="layui-input" required>
                            </div>
                            <br>
                            <label class="layui-form-label">密码</label>
                            <div class="layui-input-block">
                                <%--<input type="password" name="user.userPassword" lay-verify="pass" placeholder="请输入密码" autocomplete="off" class="layui-input">--%>
                                <input type="password" name="user.userPassword"  lay-verify="pass" autocomplete="off" placeholder="请输入密码" class="layui-input" required>
                            </div>
                            <br>
                            <label class="layui-form-label">手机号码</label>
                            <div class="layui-input-block">
                                <input type="text" name="user.telephone" lay-verify="title" autocomplete="off" placeholder="请输入手机号码" class="layui-input" required>
                            </div>
                            <br>
                            <label class="layui-form-label">邮箱</label>
                            <div class="layui-input-block">
                                <input type="text" name="user.email" lay-verify="title" autocomplete="off" placeholder="请输入邮箱" class="layui-input" required>
                            </div>
                            <br>
                            <div class="layui-input-block">
                                <%--lay-submit=""--%>
