...
<header>
    <div id="navbg"></div>
    <div class="wrapper">
        <h1 class="logo"><a href="../index.htm" title=""><img src="../images/logo.png" width="213" height="36" alt=""/></a>
        </h1>
        <nav>
            <ul>
...
<footer>
    ...
    <div id="footerinfo">
        <div class="wrapper">
            ...
            <img src="../images/map.gif" width="258" height="190" style="text-align: right; margin-left: 500px;"
                 alt="公司位置"/>
        </div>
    </div>
</footer>
