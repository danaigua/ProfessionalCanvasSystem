...
layui.define("jquery", function(i) {
	...
	s.prototype.set = function(i) {
		...
		return n.append('<li lay-id="' + (t.id || "") + '">' + (t.title || "unnaming") + "</li>"), s.append(
			'<div class="layui-tab-item">' + (t.content || "") + "</div>"), f.hideTabMore(!0), f.tabAuto(), this
		...
		f = {
			tabClick: function(i, t, s) {
				var o = s || a(this),
					...
					u = c.attr("lay-filter");
				o.addClass(e).siblings().removeClass(e), r.eq(t).addClass(n).siblings().removeClass(n), layui.event.call(this, l,
					"tab(" + u + ")", {
						elem: c,
						index: t
					})
			...
			tabDelete: function(i, t) {
				...
				l.hasClass(e) && (l.next()[0] ? f.tabClick.call(l.next()[0], null, n + 1) : l.prev()[0] && f.tabClick.call(l.prev()[
					0], null, n - 1)), l.remove(), o.eq(n).remove(), setTimeout(function() {
					f.tabAuto()
				}, 50)
			},
			tabAuto: function() {
				...
				a(".layui-tab").each(function() {
					var s = a(this),
						...
						r = a('<span class="layui-unselect layui-tab-bar" ' + c + "><i " + c +
			...
			hideTabMore: function(i) {
				...
				i !== !0 && "tabmore" === a(i.target).attr("lay-stope") || (t.removeClass("layui-tab-more"), t.find(
			...
			clickThis: function() {
				var i = a(this),
					t = i.parents(o),
					n = t.attr("lay-filter");
				i.find("." + d)[0] || (t.find("." + e).removeClass(e), i.addClass(e), layui.event.call(this, l, "nav(" + n + ")",
					i))
			},
			clickChild: function() {
				var i = a(this),
			...
			collapse: function() {
				...
				e[c ? "addClass" : "removeClass"](n), t.html(c ? "&#xe61a;" : "&#xe602;"), layui.event.call(this, l, "collapse(" +
					o + ")", {
						title: i,
						content: e,
						show: c
			...
			nav: function() {
				var i, l, e, s = 200,
					p = function(o, c) {
						...
						c.hasClass(u) ? o.css({
							...
							}, t.ie && t.ie < 10 ? 0 : s), clearTimeout(e), "block" === f.css("display") && clearTimeout(l), l =
							setTimeout(function() {
				...
				a(o).each(function() {
					...
					t.find("." + r)[0] || (t.append(o), y.on("mouseenter", function() {
						...
						i.off("click", f.clickThis).on("click", f.clickThis), i.children("a").off("click", f.showChild).on(
							"click", f.showChild), t.children("dd").off("click", f.clickChild).on("click", f.clickChild)
					})
				})
			},
			breadcrumb: function() {
			...
			collapse: function() {
				...
				a("." + i).each(function() {
					...
					i.each(function() {
						...
						t.find(".layui-colla-icon").remove(), t.append('<i class="layui-icon layui-colla-icon">' + (e ?
							"&#xe602;" : "&#xe61a;") + "</i>"), t.off("click", f.collapse).on("click", f.collapse)
					})
				})
			}
		};
